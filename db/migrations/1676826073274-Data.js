module.exports = class Data1676826073274 {
    name = 'Data1676826073274'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "token" ("id" character varying NOT NULL, "index" numeric NOT NULL, "uri" text NOT NULL, "image" text, "attributes" jsonb, "owner_id" character varying, CONSTRAINT "PK_82fae97f905930df5d62a702fc9" PRIMARY KEY ("id"))`)
